    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-platinum/55 text-sm">{pubs.length} total · {pubs.filter(p=>p.published).length} published</p>
        </div>
        <Link href="/admin/publications/new" className="flex items-center gap-2 px-4 py-2.5 bg-gold text-obsidian text-sm font-display font-semibold hover:bg-gold-dim transition-colors duration-200">
